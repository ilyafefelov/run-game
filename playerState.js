...
export class Sitting extends State {
  ...
  enter() {
    // console.log("player is sitting", this.game);
...
export class Running extends State {
  ...
  handleInput(input) {
    // console.log("RUNNNNN:", this.game.player.x, this.game.player.y);
    ...
    if (this.game.player.onGround()) {
      ...
      for (let i = 0; i < 30; i++) {
        this.game.particles.unshift(
          new Splash(
            this.game,
            this.game.player.x + 3,
            this.game.player.y - this.game.player.height / 4
          )
        );
      }
    } else if (!input.includes("Enter") && this.game.player.onGround()) {
